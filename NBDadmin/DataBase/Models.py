...
class Global_Send(models.Model):
    ...
    tg_id = fields.BigIntField(null=True)
    button_id = fields.IntField(null=True)
...
class Edit_History(models.Model):
    id = fields.IntField(pk=True)
    sug_id = fields.ForeignKeyField("models.Suggestion", related_name="history", null=True, on_delete=fields.SET_NULL)
    old_version = fields.JSONField(null=True)
    new_version = fields.JSONField(null=True)
    author_edit = fields.ForeignKeyField("models.User", related_name="history", null=True, on_delete=fields.SET_NULL)
    edit_datetime = fields.DatetimeField(auto_now_add=True)
